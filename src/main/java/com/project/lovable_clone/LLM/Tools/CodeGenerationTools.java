...
public class CodeGenerationTools {
    ...
    description = "Read the content of files. Only input the file names present inside the FILE_TREE. Only input the file names present inside the FILE_TREE. DO NOT input any path which is not present under the FILE_TREE"
            )
    public List<String> readFiles(
        ...
        for(String path : paths){
            ...
            log.info("requested filename: {}", cleanPath);
